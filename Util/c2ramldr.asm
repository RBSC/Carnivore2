...
DEF06A:	
	...
	ld	de,Record+04
	ld	hl,RAM_TEMPL
	ldir				; copy info from RAM template to record including "R" identifier (RAM)
...
H_PAR_S:
	...
	db	" c2ramldr [filename.rom] [/h] [/v] [/a] [/p]",13,10,13,10
	db	"Command line options:",13,10
	db	" /h  - this help screen",13,10
	db	" /v  - verbose mode (show detailed information)",13,10
	db	" /p  - don't protect cartridge's RAM after copying the ROM",10,13
